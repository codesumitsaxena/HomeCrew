          ...
          <div className="row mt-4 g-3">
            ...
            <div className="col-md-6">
              <div className="row g-3">
                <div className="col-6">
                  <div className="bg-white p-3 rounded shadow-sm" style={{ height: "125px" }}>
                ...
                <div className="col-6">
                  <div className="bg-warning-subtle p-3 rounded shadow-sm" style={{ height: "125px" }}>
                ...
                <div className="col-6">
                  <div className="bg-primary-subtle p-3 rounded shadow-sm" style={{ height: "125px" }}>
